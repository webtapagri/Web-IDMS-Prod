...
class RoadController extends Controller
{
	...
	public function category(Request $request)
	{
		...
		return view('road.category', compact('data','title'));
	}
	...
	public function category_datatables()
	{
		...
		return Datatables::eloquent($model)
			->addColumn('action', '<div class="text-center">
					<button class="btn btn-link text-primary-600" onclick="edit({{ $id }}, \'{{ $category_name }}\'); return false;">
						<i class="icon-pencil7"></i> Edit
					</button>
	...
	public function sacategory_save(Request $request)
	{
		try {
	...
	public function category_update(RoadStatusRequest $request)
	{
		try {
